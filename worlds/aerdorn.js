...
t(-5,12,'building','The Salt & Sail Inn',{interiorType:'inn'});
t(-5,16,'building','Market Hall',{interiorType:'market_hall'});
t(4,12,'building','Chandler & Rope',{interiorType:'shop'});
t(4,16,'building','Spice Merchant',{interiorType:'shop'});
t(-2,9,'building',"Fletcher's Stall",{interiorType:'shop'});
t(2,9,'building','Grain Exchange',{interiorType:'shop'});
t(-2,19,'building','Apothecary',{interiorType:'shop'});
t(2,19,'building','Moneylender',{interiorType:'shop'});
...
t(6,19,'building',"Fisher's Cottage",{interiorType:'house'});
t(7,19,'building',"Fisher's Cottage",{interiorType:'house'});
t(9,19,'building',"Fisher's Cottage",{interiorType:'house'});
t(11,19,'building',"Fisher's Cottage",{interiorType:'house'});
t(6,16,'building',"Fisher's Cottage",{interiorType:'house'});
t(7,16,'building',"Fisher's Cottage",{interiorType:'house'});
t(9,16,'building',"Fisher's Cottage",{interiorType:'house'});
t(6,15,'building','Smokehouse',{interiorType:'shop'});

// ── MERCHANT QUARTER (NW) ───────────────────────
t(-6,23,'building','Merchant House',{interiorType:'house'});
t(-7,23,'building','Merchant House',{interiorType:'house'});
t(-9,23,'building','Merchant House',{interiorType:'house'});
t(-11,23,'building','Merchant House',{interiorType:'house'});
t(-13,23,'building','Merchant House',{interiorType:'house'});
t(-6,26,'building','Merchant House',{interiorType:'house'});
t(-9,26,'building','Merchant House',{interiorType:'house'});
t(-11,26,'building','Merchant House',{interiorType:'house'});
t(-13,26,'building','Merchant House',{interiorType:'house'});
t(-6,19,'building','Notary & Scribe',{interiorType:'shop'});
t(-9,19,'building','Merchant House',{interiorType:'house'});
t(-11,19,'building','Merchant House',{interiorType:'house'});
t(-13,19,'building','Merchant House',{interiorType:'house'});

// ── RESIDENTIAL (SW) ─────────────────────────────
t(-6,11,'building','Chapel of the Tides',{interiorType:'chapel'});
t(-7,11,'building','Chapel of the Tides',{interiorType:'chapel'});
t(-6,10,'building','Chapel of the Tides',{interiorType:'chapel'});
t(-7,10,'building','Chapel of the Tides',{interiorType:'chapel'});
t(-6,7,'building','House',{interiorType:'house'});
t(-7,7,'building','House',{interiorType:'house'});
t(-9,7,'building','House',{interiorType:'house'});
t(-11,7,'building','House',{interiorType:'house'});
t(-13,7,'building','House',{interiorType:'house'});
t(-6,3,'building','House',{interiorType:'house'});
t(-7,3,'building','House',{interiorType:'house'});
t(-9,3,'building','House',{interiorType:'house'});
t(-11,3,'building','House',{interiorType:'house'});
t(-13,3,'building','House',{interiorType:'house'});

// ── TRADESMEN'S ROW (SE) ─────────────────────────
t(6,11,'building','Blacksmith',{interiorType:'blacksmith'});
...
t(9,11,'building','Bathhouse',{interiorType:'bathhouse'});
t(9,10,'building','Bathhouse',{interiorType:'bathhouse'});
t(6,7,'building','Tannery',{interiorType:'shop'});
t(9,7,'building','Carpenter',{interiorType:'shop'});
t(6,3,'building','House',{interiorType:'house'});
t(7,3,'building','House',{interiorType:'house'});
t(9,3,'building','House',{interiorType:'house'});
t(11,3,'building','House',{interiorType:'house'});
t(13,3,'building','House',{interiorType:'house'});
t(6,8,'building','House',{interiorType:'house'});
t(9,8,'building','House',{interiorType:'house'});
t(11,8,'building','House',{interiorType:'house'});
t(13,8,'building','House',{interiorType:'house'});

// ── HARBORMASTER ──────────────────────────────────────
t(10,14,'building','Harbormaster',{interiorType:'harbormaster'});
