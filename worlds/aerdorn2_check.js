...
(function(){
  ...
  sdef(-25,15,-2,28,'grass','Market District');
  sdef(2,15,25,28,'building','Guild District');
  sdef(-25,32,-2,55,'grass','Temple District');
...
(function(){
  ...
  sdef(-18,2,-2,18,'grass','Outer Bailey');
...
(function(){
  ...
  sdef(-12,16,-2,26,'grass','The Old Grove');
...
(function(){
  ...
  m[`0,6`]={type:'grass',name:'Village Well'};
...
(function(){
  ...
  m[`0,5`]={type:'grass',name:'Village Centre'};
...
(function(){
  ...
  m[`0,4`]={type:'grass',name:'The Salt Well'};
...
(function(){
  ...
  m[`0,5`]={type:'grass',name:'Grain Square'};
