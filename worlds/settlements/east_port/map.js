...
(function(){
  ...
  t(10,1,'mud','');
  t(11,1,'mud','');
  t(12,1,'mud','', {object:"logpile",objVariant:0});
  t(13,1,'shallow_water','');
  t(14,1,'water','');
  t(15,1,'water','');
  t(16,1,'water','');
  ...
  t(2,2,'grass','', {object:"graveyard",objVariant:0});
  ...
  t(10,2,'mud','');
  t(11,2,'mud','');
  t(12,2,'mud','', {object:"logpile",objVariant:0});
  t(13,2,'shallow_water','');
  t(14,2,'water','');
  t(15,2,'water','');
  t(16,2,'water','');
  ...
  t(12,3,'floor_h','', {terrainStyle:0,object:"logpile",rotation:90,objVariant:0});
  t(13,3,'floor_h','House', {terrainStyle:0,interiorType:"house",doors:["west"],enter:{layer:"interior",id:"ep_house_se5",entryPos:{x:1,y:1}},object:"logpile",objVariant:0});
  t(14,3,'water','');
  t(15,3,'water','');
  t(16,3,'water','');
  t(17,3,'water','');
  ...
  t(2,4,'grass','', {object:"graveyard",objVariant:0});
  ...
  t(10,4,'mud','');
  t(11,4,'mud','');
  t(12,4,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,4,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,4,'water','');
  t(15,4,'water','');
  t(16,4,'water','');
  t(17,4,'water','');
  t(-5,5,'street','Chapel Lane');
  t(-4,5,'courtyard','', {object:"mushroom_lg",objVariant:0});
  t(-3,5,'grass','', {object:"mushroom_lg",objVariant:0});
  ...
  t(10,5,'mud','');
  t(11,5,'mud','');
  t(12,5,'floor_h','East-Port Harbour', {terrainStyle:0,object:"cart",objVariant:0});
  t(13,5,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,5,'water','');
  t(15,5,'water','');
  t(16,5,'water','');
  t(17,5,'water','');
  ...
  t(10,6,'street','Quay Road');
  t(11,6,'street','Quay Road');
  t(12,6,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,6,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,6,'water','');
  t(15,6,'water','');
  t(16,6,'water','');
  t(17,6,'water','');
  ...
  t(10,7,'mud','');
  t(11,7,'mud','');
  t(12,7,'floor_h','East-Port Harbour', {terrainStyle:0,object:"barrels",objVariant:0});
  t(13,7,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,7,'water','');
  t(15,7,'water','');
  t(16,7,'water','');
  t(17,7,'water','');
  ...
  t(12,8,'floor_h','East-Port Harbour', {terrainStyle:0,object:"barrels",objVariant:0});
  t(13,8,'floor_h','House', {terrainStyle:0,interiorType:"house",doors:["west"],enter:{layer:"interior",id:"ep_house_se9",entryPos:{x:1,y:1}}});
  t(14,8,'water','');
  t(15,8,'grass','', {object:"bridge",objVariant:0});
  t(16,8,'water','');
  t(17,8,'water','');
  ...
  t(10,9,'mud','');
  t(11,9,'mud','');
  t(12,9,'floor_h','East-Port Harbour', {terrainStyle:0,objVariant:0});
  t(13,9,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,9,'water','');
  t(15,9,'water','');
  t(16,9,'water','');
  t(17,9,'water','');
  ...
  t(10,10,'mud','');
  t(11,10,'mud','');
  t(12,10,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,10,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,10,'water','');
  t(15,10,'water','');
  t(16,10,'water','');
  t(17,10,'water','');
  ...
  t(10,11,'mud','');
  t(11,11,'mud','');
  t(12,11,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,11,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,11,'water','');
  t(15,11,'water','');
  t(16,11,'water','');
  t(17,11,'water','');
  ...
  t(12,12,'floor_h','East-Port Harbour', {terrainStyle:0,objVariant:0});
  t(13,12,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,12,'water','');
  t(15,12,'water','');
  t(16,12,'water','');
  t(17,12,'water','');
  ...
  t(12,13,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,13,'floor_h','East-Port Harbour', {terrainStyle:0,object:"barrels",objVariant:0});
  t(14,13,'water','', {objVariant:0});
  t(15,13,'water','', {rotation:90,objVariant:0});
  t(16,13,'water','', {object:"boat",objVariant:0});
  t(17,13,'water','');
  ...
  t(12,14,'floor_h','Harbour Street', {terrainStyle:0});
  t(13,14,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,14,'floor_h','', {terrainStyle:0});
  t(15,14,'floor_h','', {terrainStyle:0});
  t(16,14,'floor_h','', {terrainStyle:0});
  t(17,14,'water','');
  ...
  t(12,15,'floor_h','East-Port Harbour', {terrainStyle:0,object:"torch",rotation:270,objVariant:0});
  t(13,15,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,15,'water','', {object:"boat",objVariant:0});
  t(15,15,'water','');
  t(16,15,'water','');
  t(17,15,'water','');
  ...
  t(12,16,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,16,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,16,'water','');
  t(15,16,'water','');
  t(16,16,'water','');
  t(17,16,'water','');
  ...
  t(11,17,'mud','');
  t(12,17,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,17,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,17,'floor_h','', {terrainStyle:0});
  t(15,17,'floor_h','', {terrainStyle:0});
  t(16,17,'floor_h','', {terrainStyle:0});
  t(17,17,'water','');
  ...
  t(11,18,'mud','');
  t(12,18,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,18,'floor_h','East-Port Harbour', {terrainStyle:0,object:"barrels",objVariant:0});
  t(14,18,'water','', {object:"boat",objVariant:0});
  t(15,18,'water','');
  t(16,18,'water','');
  t(17,18,'water','');
  ...
  t(12,19,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,19,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,19,'water','');
  t(15,19,'water','', {rotation:90,objVariant:0});
  t(16,19,'water','', {object:"boat",objVariant:0});
  t(17,19,'water','');
  ...
  t(11,20,'mud','');
  t(12,20,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,20,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,20,'water','');
  t(15,20,'water','');
  t(16,20,'water','');
  t(17,20,'water','');
  ...
  t(11,21,'mud','');
  t(12,21,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,21,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,21,'water','');
  t(15,21,'water','');
  t(16,21,'water','');
  t(17,21,'water','');
  ...
  t(11,22,'street','Chandler\'s Walk');
  t(12,22,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,22,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,22,'water','');
  t(15,22,'water','');
  t(16,22,'water','');
  t(17,22,'water','');
  ...
  t(12,23,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,23,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,23,'water','');
  t(15,23,'water','');
  t(16,23,'water','');
  t(17,23,'water','');
  ...
  t(12,24,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(13,24,'floor_h','East-Port Harbour', {terrainStyle:0});
  t(14,24,'water','');
  t(15,24,'water','');
  t(16,24,'water','');
  t(17,24,'water','');
