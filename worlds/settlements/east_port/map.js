...
(function(){
  ...
  t(9,16,'building',"Fisher's Cottage",{interiorType:'house',doors:['south'],enter:{layer:'interior',id:'ep_cottage_7',entryPos:{x:1,y:1}}});
  ...
  t(10,12,'courtyard','Dockside Yard',{object:'logpile'});
  ...
  t(8,20,'courtyard','Dockside Yard',{object:'logpile'});
