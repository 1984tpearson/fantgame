...
(function(){
  ...
  t(-2,0,'wall','Wall');
  t(-1,0,'wall','Wall');
  t(0,0,'gate','North Gate',{"exit":{"layer":"overworld","pos":{"x":139,"y":457}}});
  t(1,0,'wall','Wall');
  t(2,0,'wall','Wall');
  t(3,0,'wall','Wall');
  t(4,0,'wall','Wall');
  ...
  t(-3,2,'door','Salt House',{"enter":{"layer":"interior","id":"saltwell_inn","entryPos":{"x":1,"y":1}}});
  ...
  t(-2,10,'wall','Wall');
  t(-1,10,'wall','Wall');
  t(0,10,'gate','South Gate',{"exit":{"layer":"overworld","pos":{"x":139,"y":467}}});
  t(1,10,'wall','Wall');
  t(2,10,'wall','Wall');
  t(3,10,'wall','Wall');
  t(4,10,'wall','Wall');
