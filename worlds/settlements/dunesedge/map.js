...
(function(){
  ...
  t(-2,12,'wall','Wall');
  t(-1,12,'wall','Wall');
  t(0,12,'gate','North Gate',{"exit":{"layer":"overworld","pos":{"x":166,"y":410}}});
  t(1,12,'wall','Wall');
  t(2,12,'wall','Wall');
  t(3,12,'wall','Wall');
  t(4,12,'wall','Wall');
  ...
  t(-3,10,'door','The Dusty Boot',{"enter":{"layer":"interior","id":"dunesedge_inn","entryPos":{"x":1,"y":1}}});
  ...
  t(-2,0,'wall','Wall');
  t(-1,0,'wall','Wall');
  t(0,0,'gate','South Gate',{"exit":{"layer":"overworld","pos":{"x":166,"y":422}}});
  t(1,0,'wall','Wall');
  t(2,0,'wall','Wall');
  t(3,0,'wall','Wall');
  t(4,0,'wall','Wall');
