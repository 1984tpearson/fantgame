...
(function(){
  ...
  t(-2,0,'wall','Wall');
  t(-1,0,'wall','Wall');
  t(0,0,'gate','North Gate',{"exit":{"layer":"overworld","pos":{"x":250,"y":538}}});
  t(1,0,'wall','Wall');
  t(2,0,'wall','Wall');
  t(3,0,'wall','Wall');
  t(4,0,'wall','Wall');
  ...
  t(2,2,'building','Building');
  t(3,2,'door','The Thatch & Barrel',{"enter":{"layer":"interior","id":"theatfields_inn","entryPos":{"x":1,"y":1}}});
  t(4,2,'building','Building');
  t(5,2,'building','Building');
  t(6,2,'wall','Wall');
  t(-6,3,'wall','Wall');
  ...
  t(-2,12,'wall','Wall');
  t(-1,12,'wall','Wall');
  t(0,12,'gate','South Gate',{"exit":{"layer":"overworld","pos":{"x":250,"y":550}}});
  t(1,12,'wall','Wall');
  t(2,12,'wall','Wall');
  t(3,12,'wall','Wall');
  t(4,12,'wall','Wall');
