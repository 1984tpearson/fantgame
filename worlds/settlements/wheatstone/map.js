// WHEATSTONE — settlement map
// overworldCell: 169,289  walls: 12x12  hasWalls: true
(function(){
  ...
  t(-2,12,'wall','Wall');
  t(-1,12,'wall','Wall');
  t(0,12,'gate','North Gate',{"exit":{"layer":"overworld","pos":{"x":169,"y":283}}});
  t(1,12,'wall','Wall');
  t(2,12,'wall','Wall');
  t(3,12,'wall','Wall');
  t(4,12,'wall','Wall');
  ...
  t(-3,10,'door','The Wheat Sheaf',{"enter":{"layer":"interior","id":"wheatstone_inn","entryPos":{"x":1,"y":1}}});
  ...
  t(-2,0,'wall','Wall');
  t(-1,0,'wall','Wall');
  t(0,0,'gate','South Gate',{"exit":{"layer":"overworld","pos":{"x":169,"y":295}}});
  t(1,0,'wall','Wall');
  t(2,0,'wall','Wall');
  t(3,0,'wall','Wall');
  t(4,0,'wall','Wall');
  ...
  window.SETTLEMENTS['wheatstone'] = {
    map: m,
    name: "Wheatstone",
    hasWalls: true,
    entryPos: {x:0, y:2},
    overworldCell: {x:169, y:289},
    description: "",
  };
})();
